export default {
    ...
    proxies: {
      ...
      filterInvalidAction: '筛选并选中失效 IP',
      filteringInvalid: '筛选中...',
      filterInvalidHint: '根据最近一次连通性和 Grok 质量检测结果，选中当前筛选范围内的失效 IP',
      filterInvalidDone: '已选中 {count} 个失效 IP；待检测代理未选中',
      filterInvalidEmpty: '当前筛选范围内没有已确认失效的 IP',
      filterInvalidFailed: '筛选失效 IP 失败',
      batchTest: '批量测试',
      testFailed: '失败',
      latencyFailed: '链接失败',
      ...
      batchQualityDone: '批量质量检测完成，共检测 {count} 个；优质 {healthy} 个，告警 {warn} 个，挑战 {challenge} 个，异常 {failed} 个；已选中 {invalid} 个未通过 Grok 的 IP',
    ...
    proxyPools: {
      ...
      qualityGuard: 'Grok 出口质量守护',
      qualityMode: '守护模式',
      qualityPassive: '仅被动观测',
      qualityActive: '仅主动探测',
      qualityHybrid: '主动 + 被动',
      activeInterval: '主动探测间隔（秒）',
      passiveWindow: '被动采样间隔（秒）',
      quarantineSeconds: '隔离时长（秒）',
      softTps: '软阈值 Token/s',
      hardTps: '硬阈值 Token/s',
      minHealthyProxies: '最小健康出口数',
      consecutiveSoft: '连续软异常次数',
      consecutiveErrors: '连续传输异常次数',
      minGenerationMs: '最短生成窗口（毫秒）',
      minOutputTokens: '最小采样输出 Token',
      maxProbeTokens: '主动探针最大 Token',
      qualityModel: '主动探测模型',
      thinkingGuard: '检测缺失 thinking',
      missingThinkingCount: '连续缺失 thinking 次数',
      thinkingCrossVerify: 'thinking 异常交叉复测',
      softCrossVerify: '软阈值交叉复测',
      disableAccountOnHard: '迁号失败时临时停用账号',
      qualityThresholdInvalid: '软阈值必须低于硬阈值',
      qualityClassHealthy: '质量正常',
      qualityClassIgnored: '已忽略',
      qualityClassSoft: '软异常',
      qualityClassHard: '硬异常',
      qualityClassError: '传输异常',
      qualityQuarantinedUntil: '隔离至 {time}',
      qualityAwaitingRecovery: '等待主动恢复复测',
      qualityObservedAccount: '最近检测账号',
      qualityNoAvailableAccount: '无可用账号',
      qualitySourceActive: '主动探测',
      qualitySourcePassive: '被动观测',
      pool: '代理池',
      proxies: '代理数',
      proxy: '代理',
      boundAccounts: '绑定账号',
      ...
      manageGroups: '管理分组',
      noGroups: '暂未绑定分组',
      noAssignableGroups: '没有可绑定的分组',
      searchGroups: '搜索分组名称',
      groupAccounts: '{count} 个账号',
      groupBoundTo: '已绑定到：{name}',
      groupBindingHint: '分组内现有账号及之后加入该分组的账号，会自动接入此代理池。账号属于多个绑定分组时按分组优先级处理。',
      bindGroupsSuccess: '已绑定 {groups} 个分组，已同步 {accounts} 个账号',
      bindGroupsFailed: '绑定分组失败',
      unbindGroup: '解除分组绑定',
      unbindGroupsTitle: '解除代理池分组绑定',
      unbindGroupsConfirm: '确定解除“{name}”与此代理池的绑定吗？该分组账号将不再由此代理池自动接管。',
      unbindGroupsSuccess: '已解除分组绑定，{accounts} 个账号停止由该池管理',
      unbindGroupsFailed: '解除分组绑定失败',
      groupBindingBusy: '分组绑定操作正在进行，请稍后重试',
      members: '池成员',
      exit: '出口 IP',
      latency: '延迟',
      checkedAt: '最近检测',
      ...
      grokQuality: 'Grok 质量',
      grokQualityPassed: '通过',
      grokQualityWarn: '告警',
      grokQualityChallenge: '被拦截',
      grokQualityFailed: '失败',
      grokQualityPending: '待检测',
      checkNow: '立即检测并切换',
      checkStarted: '代理池检测已在后台启动，健康状态会逐步更新',
      checkRunning: '代理池检测正在进行，无需重复启动',
      ssoQualityCheck: 'SSO 降智检测',
      ssoQualityStarted: '已开始检测 {count} 个账号的 SSO 降智状态，结果会逐步更新',
      ssoQualityRunning: 'SSO 降智检测正在进行，无需重复启动',
      ssoQualityNoAccounts: '池内没有可检测的已记录 SSO 账号',
      ssoQualityFailed: 'SSO 降智检测启动失败',
      addProxies: '添加代理',
      addSelected: '添加选中代理',
      removeProxy: '移出代理池',
      searchMembers: '搜索名称、地址或出口 IP',
      filterAll: '全部状态',
      filterHealthy: '健康',
      filterInvalid: '失效',
      filterPending: '待检测',
      selectProxy: '选择代理 {name}',
      selectInvalid: '筛选失效 IP（{count}）',
      removeSelected: '批量移出（{count}）',
      removeSelectedTitle: '批量移出代理池',
      removeSelectedConfirm: '确定将选中的 {count} 个代理移出代理池吗？使用这些 IP 的账号会等待代理池重新分配；全局代理不会被删除。',
      removeSelectedDone: '已将 {count} 个代理移出代理池',
      rebindLogs: '自动切换记录',
      noLogs: '暂无自动切换记录',
      noPools: '暂无代理池',
      noMembers: '池内暂无代理',
      noMatchingMembers: '没有符合当前筛选条件的代理',
      noAssignableProxies: '没有可添加的启用代理',
      selectPool: '选择代理池',
      bindAccountsTitle: '批量绑定代理池',
      bindAccountsHint: '将 {count} 个账号分配到池内当前负载最低的健康代理；暂无健康 IP 时会自动等待分配。',
      bindAccounts: '绑定账号',
      binding: '绑定中...',
      bindSuccess: '已为 {count} 个账号绑定代理池',
      bindPending: '已绑定 {count} 个账号，将在出现健康 IP 后自动分配',
