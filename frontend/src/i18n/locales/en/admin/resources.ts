export default {
    ...
    proxies: {
      ...
      filterInvalidAction: 'Find & Select Invalid IPs',
      filteringInvalid: 'Filtering...',
      filterInvalidHint: 'Select invalid IPs in the current filter scope using the latest connectivity and Grok quality results',
      filterInvalidDone: 'Selected {count} invalid IPs; unchecked proxies were not selected',
      filterInvalidEmpty: 'No confirmed invalid IPs in the current filter scope',
      filterInvalidFailed: 'Failed to filter invalid IPs',
      ...
      batchQualityDone:
        'Batch quality check completed for {count} proxies: healthy {healthy}, warn {warn}, challenge {challenge}, abnormal {failed}; selected {invalid} IPs that failed Grok',
    ...
    proxyPools: {
      ...
      qualityGuard: 'Grok Egress Quality Guard',
      qualityMode: 'Guard Mode',
      qualityPassive: 'Passive only',
      qualityActive: 'Active only',
      qualityHybrid: 'Active + passive',
      activeInterval: 'Active Probe Interval (seconds)',
      passiveWindow: 'Passive Sample Interval (seconds)',
      quarantineSeconds: 'Quarantine Duration (seconds)',
      softTps: 'Soft Threshold Token/s',
      hardTps: 'Hard Threshold Token/s',
      minHealthyProxies: 'Minimum Healthy Exits',
      consecutiveSoft: 'Consecutive Soft Anomalies',
      consecutiveErrors: 'Consecutive Transport Errors',
      minGenerationMs: 'Minimum Generation Window (ms)',
      minOutputTokens: 'Minimum Sample Output Tokens',
      maxProbeTokens: 'Active Probe Maximum Tokens',
      qualityModel: 'Active Probe Model',
      thinkingGuard: 'Guard missing thinking',
      missingThinkingCount: 'Consecutive Missing-thinking Samples',
      thinkingCrossVerify: 'Cross-verify thinking anomalies',
      softCrossVerify: 'Cross-verify soft anomalies',
      disableAccountOnHard: 'Temporarily disable accounts when migration fails',
      qualityThresholdInvalid: 'The soft threshold must be lower than the hard threshold',
      qualityClassHealthy: 'Quality healthy',
      qualityClassIgnored: 'Ignored',
      qualityClassSoft: 'Soft anomaly',
      qualityClassHard: 'Hard anomaly',
      qualityClassError: 'Transport error',
      qualityQuarantinedUntil: 'Quarantined until {time}',
      qualityAwaitingRecovery: 'Awaiting active recovery probe',
      qualityObservedAccount: 'Last checked account',
      qualityNoAvailableAccount: 'No available account',
      qualitySourceActive: 'Active probe',
      qualitySourcePassive: 'Passive observation',
      pool: 'Proxy Pool',
      proxies: 'Proxies',
      proxy: 'Proxy',
      ...
      noAssignableGroups: 'No groups available to bind',
      searchGroups: 'Search group names',
      groupAccounts: '{count} account(s)',
      groupBoundTo: 'Bound to: {name}',
      groupBindingHint: 'Existing accounts in the group and accounts added later will automatically enter this proxy pool. When an account belongs to multiple bound groups, group priority decides ownership.',
      bindGroupsSuccess: 'Bound {groups} group(s) and synchronized {accounts} account(s)',
      bindGroupsFailed: 'Failed to bind groups',
      unbindGroup: 'Unbind group',
      unbindGroupsTitle: 'Unbind Group from Proxy Pool',
      unbindGroupsConfirm: 'Unbind "{name}" from this proxy pool? Accounts in the group will no longer be managed automatically by this pool.',
      unbindGroupsSuccess: 'Group unbound; {accounts} account(s) are no longer managed by this pool',
      unbindGroupsFailed: 'Failed to unbind group',
      groupBindingBusy: 'A group binding operation is already running; try again shortly',
      ...
      grokQualityPassed: 'Passed',
      grokQualityWarn: 'Warning',
      grokQualityChallenge: 'Blocked',
      grokQualityFailed: 'Failed',
      grokQualityPending: 'Pending',
      ...
      ssoQualityCheck: 'SSO Risk Scan',
      ssoQualityStarted: 'Started SSO risk scan for {count} accounts; results will update progressively',
      ssoQualityRunning: 'The SSO risk scan is already running',
      ssoQualityNoAccounts: 'No pool accounts with stored SSO cookies are available',
      ssoQualityFailed: 'Failed to start the SSO risk scan',
      addProxies: 'Add Proxies',
      addSelected: 'Add Selected',
      removeProxy: 'Remove from Pool',
      searchMembers: 'Search name, address, or exit IP',
      filterAll: 'All Status',
      filterHealthy: 'Healthy',
      filterInvalid: 'Invalid',
      filterPending: 'Pending',
      selectProxy: 'Select proxy {name}',
      selectInvalid: 'Filter Invalid IPs ({count})',
      removeSelected: 'Remove Selected ({count})',
      removeSelectedTitle: 'Remove Proxies from Pool',
      removeSelectedConfirm: 'Remove the selected {count} proxies from this pool? Accounts using these IPs will wait for reassignment; global proxy records will not be deleted.',
      removeSelectedDone: 'Removed {count} proxies from the pool',
      rebindLogs: 'Automatic Rebind Log',
      noLogs: 'No automatic rebinds yet',
      noPools: 'No proxy pools',
      noMembers: 'No proxies in this pool',
      noMatchingMembers: 'No proxies match the current filters',
      ...
      bindAccountsHint: 'Assign {count} account(s) to the least-loaded healthy proxies; wait automatically when none are healthy.',
      bindAccounts: 'Bind Accounts',
      binding: 'Binding...',
      bindSuccess: 'Bound {count} account(s) to the proxy pool',
      bindPending: 'Bound {count} account(s); they will be assigned automatically when a healthy IP is available',
