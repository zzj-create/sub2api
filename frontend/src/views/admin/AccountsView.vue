...
import BindProxyPoolModal from '@/components/admin/account/BindProxyPoolModal.vue'
...
const handleProxyPoolBound = () => {
  showBindProxyPool.value = false
  clearSelection()
  reload()
  void loadProxyPools()
}
