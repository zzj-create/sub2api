...
func registerProxyPoolRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	pools := admin.Group("/proxy-pools")
	{
		...
		pools.GET("/:id/groups", h.Admin.ProxyPool.GetGroups)
		pools.GET("/:id/group-options", h.Admin.ProxyPool.GetGroupOptions)
		pools.POST("/:id/groups", h.Admin.ProxyPool.BindGroups)
		pools.DELETE("/:id/groups", h.Admin.ProxyPool.UnbindGroups)
