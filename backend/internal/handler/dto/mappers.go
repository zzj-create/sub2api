...
func ProxyPoolProxyFromService(p *service.ProxyPoolProxy) *ProxyPoolProxy {
	...
	return &ProxyPoolProxy{
		...
		QualityStrikes:         p.QualityStrikes,
		QualityThinkingStrikes: p.QualityThinkingStrikes,
		QualityErrorStrikes:    p.QualityErrorStrikes,
		QuarantinedUntil:       p.QuarantinedUntil,
		QualityOutputTPS:       p.QualityOutputTPS,
		QualityOutputTokens:    p.QualityOutputTokens,
		QualityDurationMs:      p.QualityDurationMs,
		QualityFirstTokenMs:    p.QualityFirstTokenMs,
		QualityLastSource:      p.QualityLastSource,
